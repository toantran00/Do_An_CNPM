// ===== PROMOTIONS LOCKED STATE JAVASCRIPT =====

class PromotionsLockedManager {
    constructor() {
        this.init();
    }
    ...
    disableInteractiveElements() {
        ...
        // Remove click events from action buttons in promotions section only
        ...
        // Disable pagination in promotions section only
    ...
    showLockedStateIndicators() {
        // Add locked indicator to action areas only in promotions section
        this.addLockedIndicator('.stats-container .vendor-action-buttons', 'Chức năng bị khóa');
        this.addLockedIndicator('.stats-container .table-container', 'Chỉ có thể xem khuyến mãi');
        this.addLockedIndicator('.stats-container .filter-section', 'Bộ lọc chỉ để xem');
        this.addLockedIndicator('.stats-container .btn-add', 'Không thể thêm khuyến mãi mới');
    ...
    bindEvents() {
        // Show locked message when trying to interact with disabled elements in promotions section only
        ...
        // Prevent pagination in promotions section only
        document.querySelectorAll('.stats-container .pagination .page-link').forEach(link => {
        ...
        // Prevent search form submission in promotions section only
    ...
    showLockedMessage() {
        this.showToast('warning', 
            'Cửa hàng của bạn đang bị khóa. Bạn không thể thực hiện thao tác quản lý khuyến mãi.', 
            5000
        );
    }
...
const lockedStyles = `
    ...
    /* Additional styles for promotions-specific elements */
    ...
    .stats-container .form-check-input:disabled {
...
document.addEventListener('DOMContentLoaded', function() {
    window.promotionsLockedManager = new PromotionsLockedManager();
});